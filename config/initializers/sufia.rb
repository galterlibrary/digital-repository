Sufia.config do |config|
  ...
  config.resource_types_to_schema = {
    ...
    "Dictionary" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Dictionary",
    "Directory" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Directory",
    "Dissertation" => "http://schema.org/ScholarlyArticle",
    "Duplicate Publication" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Duplicate Publication",
    ...
    "Interactive Tutorial" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Interactive Tutorial",
    ...
    "Meta-Analysis" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Meta-Analysis",
    "Multicenter Study" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Multicenter Study",
    ...
    "Patient Education Handout" => "https://github.com/vioil/ontology_extensions/blob/master/VlocalVI.rdf#Patient Education Handout",
