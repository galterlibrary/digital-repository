...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("page_number", :stored_searchable), label: "Page Number"
    config.add_index_field solr_name("multi_page", :stored_searchable), label: "Multi Page"
